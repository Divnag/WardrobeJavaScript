...
namespace WardrobeDBFirstMVC.Controllers
{
    public class OccassionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccassionID,Occassion1")] Occassion occassion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccassionID,Occassion1")] Occassion occassion)
        {
            if (ModelState.IsValid)
            {
