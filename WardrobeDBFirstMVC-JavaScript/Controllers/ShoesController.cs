...
namespace WardrobeDBFirstMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,ShoePhoto,Color,SeasonID,OccassionID")] Shoe shoe)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occassions, "OccassionID", "Occassion1", shoe.OccassionID);
            ViewBag.SeasonID = new SelectList(db.Seasons1, "SeasonID", "Season", shoe.SeasonID);
            return View(shoe);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,ShoePhoto,Color,SeasonID,OccassionID")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
